...
软件是近百年发展最快的技术之一，特别是随着智能手机与平板电脑的普及，软件技术更是渗透到了我们生活的各个方面。学会编程，并不意味着要去要去建一个复杂的系统。其实写个报表的计算公式或者做一个小动画也可以是一种编程的体验。
...
* 2019Google镜像地址：：http://ac.scmor.com/ ,其包含谷歌学术镜像与网页镜像。
